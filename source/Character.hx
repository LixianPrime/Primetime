...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'lixian':
					frames = Paths.getSparrowAtlas('Lixian');
					animation.addByPrefix('idle', 'LixianIdle', 24, false);
					animation.addByPrefix('singUP', 'LixianUpNote', 24, false);
					animation.addByPrefix('singLEFT', 'LixianNoteLeft', 24, false);
					animation.addByPrefix('singRIGHT', 'LixianNoteRight', 24, false);
					animation.addByPrefix('singDOWN', 'LixianDownNote', 24, false);
